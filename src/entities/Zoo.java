...
public class Zoo {
    ...
    private entities.Animal[] animals;
    ...
    public Zoo(String name, String city) {
        this.name = name;
        this.city = city;
        this.animals = new entities.Animal[NBR_CAGES];
    }

    //Methodes
    public boolean addAnimal(entities.Animal animal){
    ...
    //Remove
    public boolean removeAnimal(entities.Animal a){
    ...
    //Search
    public int searchAnimal(entities.Animal a) {
    ...
    public entities.Animal[] getAnimals() {
        return animals;
    }
